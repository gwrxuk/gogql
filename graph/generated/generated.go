...
type ComplexityRoot struct {
	...
	Query struct {
		LastProject func(childComplexity int, n int) int
	}
}

type QueryResolver interface {
	LastProject(ctx context.Context, n int) ([]*model.Projects, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Projects.info":
		if e.complexity.Projects.Info == nil {
			break
		}

		return e.complexity.Projects.Info(childComplexity), true

	case "Query.last_project":
		if e.complexity.Query.LastProject == nil {
			break
		}

		args, err := ec.field_Query_last_project_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.LastProject(childComplexity, args["n"].(int)), true
...
func (ec *executionContext) field_Query_last_project_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 int
...
func (ec *executionContext) _Projects_info(ctx context.Context, field graphql.CollectedField, obj *model.Projects) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Query_last_project(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	args, err := ec.field_Query_last_project_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().LastProject(rctx, args["n"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNProjects2ᚕᚖgwrxukᚋgraphqlᚋgraphᚋmodelᚐProjects(ctx, field.Selections, res)
}
	...
	for i, field := range fields {
		...
		case "info":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Projects_info(ctx, field, obj)
			}
	...
	for i, field := range fields {
		...
		case "last_project":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Query_last_project(ctx, field)
				if res == graphql.Null {
...
func (ec *executionContext) marshalNProjects2ᚕᚖgwrxukᚋgraphqlᚋgraphᚋmodelᚐProjects(ctx context.Context, sel ast.SelectionSet, v []*model.Projects) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOProjects2ᚖgwrxukᚋgraphqlᚋgraphᚋmodelᚐProjects(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOProjects2ᚖgwrxukᚋgraphqlᚋgraphᚋmodelᚐProjects(ctx context.Context, sel ast.SelectionSet, v *model.Projects) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
